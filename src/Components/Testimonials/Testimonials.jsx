...
function Testimonials() {
  ...
  const testimonialData = [
    {
      backgroundImage: 'url("https://robotiko.tokotema.com/wp-content/uploads/2023/05/Ellipse-1.png")',
      backgroundColor: '#020505',
      feedback: "I can't say enough about the excellent work DotpotiT did on our website. They transformed it from below-average to appealing and informative website.",
    ...
    },
    {
      backgroundImage: 'url("https://robotiko.tokotema.com/wp-content/uploads/2023/05/Ellipse-1.png")',
      backgroundColor: '#020505',
      feedback: "I wanted to take a moment to thank DotpotiT for the services your team has provided. Your team has been a pleasure to work with, professional and timely. Job well done.",
      author: 'Harry Jhon',
    ...
    },
    {
      backgroundImage: 'url("https://robotiko.tokotema.com/wp-content/uploads/2023/05/Ellipse-1.png")',
      backgroundColor: '#020505',
      feedback: "We have been working with DotpotiT team for over 2 years now. I must say we have come a long way together and all along their team has been flexible to our ad-hoc requests.",
      ...
      <div>
        ...
        >
          {testimonialData.map((testimonial, index) => (
            <SwiperSlide key={index} className='rounded-lg' style={{ backgroundImage: testimonial.backgroundImage, backgroundSize: 'cover', backgroundColor: testimonial.backgroundColor }}>
              <div className='text-start p-3 lg:p-16'>
                <h2 className='text-blue-400'>Testimonials</h2>
                <h1 className='text-2xl py-2 text-gray-300'>Our Client's Feedback</h1>
          ...
          <div className="autoplay-progress rounded-full w-20 h-20" slot="container-end" style={{ overflow: 'hidden', borderRadius: '50%' }}>
            <svg viewBox="0 0 48 48" ref={progressCircle} style={{ borderRadius: '50%' }}>
