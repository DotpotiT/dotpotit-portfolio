  ...
  return (
    <div>
        <div className="navbar hidden md:hidden  flex lg:flex fixed z-10 bg-black opacity-85 px-2  md:px-2  lg:px-[120px]">
          ...
          <a href="https://dotpotit.com/" className=" btn-outline inline-block px-2 py-2 rounded-xl border-2 border-transparent text-black font-bold bg-gradient-to-r from-slate-600 to-blue-400 transform hover:rotate-y-3 hover:rotate-x-3 flex-row items-center">
