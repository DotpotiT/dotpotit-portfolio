...
function Services() {
  ...
  return (
    <div
      className="grid grid-cols-2 lg:grid-cols-3 overflow-hidden  lg:p-9 px-1 lg:px-16  w-full lg:max-w-6xl mx-auto gap-1 lg:gap-8 transform  lg:-translate-y-32 py-3 "
