...
function Products() {
  return (
    <div className='max-w-[1400px] mx-auto'>
      <h2 className='text-2xl py-5 text-center text-gray-400'>Our Recent Projects</h2>
  ...
  style={{ position: "relative", cursor: "pointer", backgroundColor: "transparent" }}
  onMouseEnter={() => {
...
>
  ...
  <div>
    <h2 className="text-gradient-primary text-center font-bold text-2xl mx-auto text-blue-400 pt-3">RMJ AUTOS</h2>
    <div
      id="rmjAutosDescription"
      style={{ opacity: 0, transition: "opacity 0.3s ease" }}
      className="flex text-center p-1 relative items-center justify-center gap-3 description"
    >
      <p className="text-lg text-semibold text-white">Web Application</p>
      <a href="https://www.rmjautos.com/" className="text-2xl text-gray-300">
        <FaEye />
      </a>
    </div>
  </div>
...
>
  ...
  <div>
    <h2 className="text-gradient-primary text-center font-bold text-2xl mx-auto text-blue-400 pt-3">Premo</h2>
    <div
      id="premoDescription"
      style={{ opacity: 0, transition: "opacity 0.3s ease" }}
      className="flex text-center p-3 relative items-center justify-center gap-3 description"
    >
      <p className="text-lg text-semibold text-white">Mobile Application</p>
      <a href="https://www.rmjautos.com/" className="text-2xl text-gray-300">
        <FaEye />
      </a>
    </div>
...
>
  ...
  <div>
    <h2 className="text-gradient-primary text-center font-bold text-2xl mx-auto text-blue-400 pt-3">Flipper</h2>
    <div
    ...
    >
      <p className="text-lg text-semibold text-white">Web Application</p>
      <a href="https://flipper.com.bd" className="text-2xl text-gray-300">
        <FaEye />
      </a>
    </div>
  </div>
...
>
  ...
  <div>
    <h2 className="text-gradient-primary text-center font-bold text-2xl mx-auto text-blue-400 pt-3">Selectel Wireless</h2>
    <div
      id="wireless"
      style={{ opacity: 0, transition: "opacity 0.3s ease" }}
      className="flex text-center p-1 relative items-center justify-center gap-3 description"
    >
      <p className="text-lg text-semibold text-white">Web Application</p>
      <a href="https://www.selectelwireless.com/" className="text-2xl text-gray-300">
        <FaEye />
      </a>
    </div>
  </div>
...
>
  ...
  <div>
    <h2 className="text-gradient-primary text-center font-bold text-2xl mx-auto text-blue-400 pt-3">Noir</h2>
    <div
      id="noirDescription"
      style={{ opacity: 0, transition: "opacity 0.3s ease" }}
      className="flex text-center p-1 relative items-center justify-center gap-3 description"
...
>
  ...
  <div>
    <h2 className="text-gradient-primary text-center font-bold text-2xl mx-auto text-blue-400 pt-3">ForeFront</h2>
    <div
    ...
    >
      <p className="text-lg text-semibold text-white">Web Application</p>
      <a href="https://www.forefront-bd.com/" className="text-2xl text-gray-300">
        <FaEye />
      </a>
    </div>
  </div>
...
>
  ...
  <div>
    <h2 className="text-gradient-primary text-center font-bold text-2xl mx-auto text-blue-400 pt-3  "> Authentika</h2>
    <div
      id="authentika"
      style={{ opacity: 0, transition: "opacity 0.3s ease" }}
      className="flex text-center p-1 relative items-center justify-center gap-3 description"
    >
      <p className="text-lg text-semibold text-white">Web Application</p>
      <a href="https://authentikabd.com/" className="text-2xl text-gray-300">
        <FaEye />
      </a>
    </div>
  </div>
...
>
  ...
  <div>
    <h2 className="text-gradient-primary text-center font-bold text-2xl mx-auto text-blue-400 pt-3  ">Evince Group BD</h2>
    <div
      id="evincegroupbd"
      style={{ opacity: 0, transition: "opacity 0.3s ease" }}
      className="flex text-center p-1 relative items-center justify-center gap-3 description"
    >
      <p className="text-lg text-semibold text-white">Web Application</p>
      <a href="https://evincegroupbd.com/" className="text-2xl text-gray-300">
        <FaEye />
      </a>
    </div>
  </div>
...
>
  ...
  <div>
    <h2 className="text-gradient-primary text-center font-bold text-2xl mx-auto text-blue-400 pt-3  pt-3">Luliz</h2>
    <div
      id="description"
      style={{ opacity: 0, transition: "opacity 0.3s ease" }}
      className="flex text-center p-1 relative items-center justify-center gap-3 description"
